#!/bin/bash
# Global SessionEnd Hook: REFLECT cognitive function
# Version: 2.1.0
#
# This hook delegates to the unified CAM Cognitive system.
# Cognitive Function: REFLECT - Summarize session, consolidate knowledge
...
INPUT=$(cat)
INPUT_WITH_EVENT=$(echo "$INPUT" | jq '. + {hook_event: "SessionEnd"}')
