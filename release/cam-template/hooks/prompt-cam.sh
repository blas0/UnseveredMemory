#!/bin/bash
# Global UserPromptSubmit Hook: PERCEIVE cognitive function
# Version: 2.1.0
#
# This hook delegates to the unified CAM Cognitive system.
# Cognitive Function: PERCEIVE - Understand intent, proactive retrieval
...
INPUT=$(cat)
INPUT_WITH_EVENT=$(echo "$INPUT" | jq '. + {hook_event: "UserPromptSubmit"}')
